...
所有 pipeline 腳本位於：
```
SKILL_DIR=/Users/fredchu/.claude/skills/srt
SUBTITLE_DIR=${SKILL_DIR}/scripts
CORRECT_DIR=${SUBTITLE_DIR}/srt_correct
# 私人術語表與媒體產物留在 user workspace（不在 skill repo）
DATA_DIR=/Users/fredchu/Documents/For_Claude/scripts/subtitle
TERMS=${DATA_DIR}/srt_correct/terms_austin_v2.txt
...
```bash
CORRECT_DIR=/Users/fredchu/.claude/skills/srt/scripts/srt_correct
